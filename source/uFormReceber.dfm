object frmFormReceb: TfrmFormReceb
  Left = 307
  Top = 205
  ...
  object pnlCheque: TPanel
    ...
    object dbeAgencia: TDBEdit
      ...
      Width = 90
      Height = 21
      DataField = 'PRE_NRAGEN'
      DataSource = dsPrestacoes
      TabOrder = 1
      OnExit = dbeAgenciaExit
    end
    ...
    object dbeNRCHEQ: TDBEdit
      ...
      Width = 90
      Height = 21
      DataField = 'PRE_NRCHEQ'
      DataSource = dsPrestacoes
      TabOrder = 3
      OnExit = dbeNRCHEQExit
    end
    object chbPRED: TDBCheckBox
      Left = 16
      Top = 78
      Width = 91
      Height = 17
      ...
      OnClick = chbPREDClick
    end
    object dbeDTPRED: TDBEdit
      Left = 260
      Top = 79
      Width = 90
      Height = 21
      DataField = 'PRE_DTPRED'
      DataSource = dsPrestacoes
      Enabled = False
      MaxLength = 10
      TabOrder = 5
    ...
    object dbeVLCHEQ: TDBEdit
      Left = 92
      Top = 115
      Width = 100
      Height = 21
      DataField = 'PRE_VLPAGO'
      DataSource = dsPrestacoes
      TabOrder = 6
      OnExit = dbeVLCHEQExit
    end
    object edtVLPAGO2: TEdit
      Left = 262
      Top = 108
      Width = 121
      Height = 21
      TabOrder = 7
      Visible = False
      OnExit = edtVLPAGO2Exit
      OnKeyPress = edtVLPAGO2KeyPress
    end
  end
