...
{    // Pesquisa por Nome do Cliente
    ...
    begin
        ...
        begin
            ...
            // Se não encontrar o nome do Servido.
            If Not (tbMotorista.Locate('MOT_NMMOTO',M_NMMOTO,[loCaseInsensitive,loPartialKey])) Then
            begin
                // Mensagem para o usuário
                Application.MessageBox( 'Nome do motorista não cadastrado!',
                   'ATENÇÃO', MB_OK+MB_ICONINFORMATION+MB_APPLMODAL);
                edtNome.Clear;
                edtNome.SetFocus;
                Exit;                   // Sair da procedure
...
begin
    ...
    begin
        ...
        begin
            ...
            begin
                // Mensagem para o usuário
                Application.MessageBox( 'Nome de cliente não cadastrado!',
                   'ATENÇÃO', MB_OK+MB_ICONINFORMATION+MB_APPLMODAL);
                edtNome.Clear;
                edtNome.SetFocus;
                Exit;                   // Sair da procedure
...
begin
    ...
    begin
        ...
        begin
            ...
            begin
                // Mensagem para o usuário
                Application.MessageBox('Nome de fornecedor não cadastrado!',
                   'ATENÇÃO', MB_OK+MB_ICONINFORMATION+MB_APPLMODAL);
                edtNome.Clear;
                edtNome.SetFocus;
                Exit;                   // Sair da procedure
...
{    If Not Funcoes.Empty(edtNome.Text) Then
    begin
        ...
        begin
            ...
            begin
                // Mensagem para o usuário
                Application.MessageBox( 'Nome de material não cadastrado.',
                   'ATENÇÃO', MB_OK+MB_ICONINFORMATION+MB_APPLMODAL);
                edtNome.Clear;
                edtNome.SetFocus;
                Exit;                   // Sair da procedure
...
begin
    ...
    begin
        With dmBD Do
        begin
            // Se não encontrar nº de Identidade.
            If Not (tbClientes.Locate('CLI_IDEINS',edtIdentidade.Text,[])) Then
            begin
                // Mensagem para o usuário
                Application.MessageBox('Identidade de cliente não cadastrado!',
                   'ATENÇÃO', MB_OK+MB_ICONINFORMATION+MB_APPLMODAL);
                edtIdentidade.Clear;
...
{    // Pesquisa por Nome do Material
    ...
    begin
        ...
        begin
            ...
            begin
                // Mensagem para o usuário
                Application.MessageBox( 'Código de material não cadastrado.',
                   'ATENÇÃO', MB_OK+MB_ICONINFORMATION+MB_APPLMODAL);
                edtIdentidade.Clear;
                edtIdentidade.SetFocus;
                Exit;                   // Sair da procedure
...
begin
  ...
  begin
      ...
      begin
           With DmBD Do
           begin
                // Se não encontrar Código do cliente.
                If Not (tbClientes.Locate('CLI_CPFCGC',edtCPFCGC.Text,[])) Then
                begin
                      // Mensagem para o usuário
                     Application.MessageBox('CPF/CGC não Cadastrado!',
                           'ATENÇÃO', MB_OK+MB_ICONINFORMATION+MB_APPLMODAL);
                     edtCodigo.Clear;
                     edtCodigo.SetFocus;
                     Exit;                   // Sair da procedure
