...
begin
  Try
     ...
     dbGRIDFORN.Visible := True;
  Except
       ShowMessage('Error ao tentar cancelar alterações.');
  End;
end;
...
begin
    If Application.MessageBox('Deseja eliminar este registro:', 'Exclusão de Fornecedor',
...
begin
     ...
     begin
         If Application.MessageBox( 'Salvar as alterações?','ATENÇÃO',
                      MB_YESNO+MB_ICONQUESTION+MB_APPLMODAL) = idYes then
               dmBD.tbFornecedores.Post          // Grava as alterações
         Else
               dmBD.tbFornecedores.Cancel;         // Cancela as alterações
     End;
     // Fechar a janela.
     Close;
end;
...
begin
     ...
     begin
          ...
          begin
               Application.MessageBox( 'Nome de fantasia já cadastrado.',
                              'ATENÇÃO', MB_OK+MB_ICONINFORMATION+MB_APPLMODAL);
               dbeNMFANT.Clear;
               dbeNMFANT.SetFocus;
          End
...
begin
     ...
     begin
          ...
          begin
          Application.MessageBox( 'Digite o número do CGC do fornecedor.',
                                  'ATENÇÃO', MB_OK+MB_ICONINFORMATION+MB_APPLMODAL);
          dbeCGC.SetFocus;
          Exit;
          End;
          ...
          begin
               Application.MessageBox( 'CGC já cadastrado.',
                              'ATENÇÃO', MB_OK+MB_ICONINFORMATION+MB_APPLMODAL);
               dbeCGC.Clear;
               dbeCGC.SetFocus;
          End
...
begin
    ...
    begin
         ...
         begin
              Application.MessageBox('Fornecedor não encontado.',
